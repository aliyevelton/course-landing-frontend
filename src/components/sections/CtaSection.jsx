        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-10">
          {ctaText && (
            <a href={ctaUrl || '#pricing'}>
              <Button variant="secondary" className="bg-white text-emerald-700 hover:bg-emerald-50 text-lg px-10 py-4 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
                {ctaText}
              </Button>
            </a>
          )}
          <a href="#contact" className="text-emerald-100 hover:text-white font-medium underline underline-offset-4 transition-colors">
            Questions? Contact us
          </a>
        </div>
        <div className="flex flex-wrap justify-center gap-6 text-emerald-100/90 text-sm font-medium">
          {ASSURANCES.map((item) => (
